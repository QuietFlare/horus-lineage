...
PYTEST_CMD = pytest --cov=src/horus_lineage --cov-report=xml --cov-report=html --cov-report=term --junitxml=test-results.xml
...
# i18n settings (babel)
BABEL_CFG = babel.cfg
LOCALE_DIR = src/horus_lineage/locale
MESSAGES_POT = $(LOCALE_DIR)/messages.pot
DOMAIN = horus_lineage
SOURCE_DIR = src/horus_lineage

# Variables used for babel metadata
PROJECT_NAME = horus-lineage
ORGANIZATION = QuietFlare
